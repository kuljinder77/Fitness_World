...
public class cardiodataadapter extends BaseAdapter
{
    Context c;
    ArrayList<Model_Getter_Setter_cardio> model_arr;
    LayoutInflater linf;
    public cardiodataadapter(Context c, ArrayList<Model_Getter_Setter_cardio> model_arr)
    {
        this.c = c;
