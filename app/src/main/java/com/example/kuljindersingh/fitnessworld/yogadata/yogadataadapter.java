...
public class yogadataadapter extends BaseAdapter
{
    Context c;
    ArrayList<Model_Getter_Setter_yoga> model_arr;
    LayoutInflater linf;
    public yogadataadapter(Context c, ArrayList<Model_Getter_Setter_yoga> model_arr)
    {
        this.c = c;
